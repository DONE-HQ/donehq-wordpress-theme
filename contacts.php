...
if( $footer_phone ) {
   ...
   $phone_sanitized = str_replace(['+', '-', ' '], '', $footer_phone);
    echo '
        <a id="w-node-_006635a8-a843-090c-9039-bd6d28ce1c36-fcacf474" href="tel:' . esc_html($phone_sanitized) . '" class="contact__item item--dark-blue w-inline-block">
        ...
        <div id="w-node-f9ffd93a-5a6e-77c3-fee2-ec6f8e3aa989-fcacf474" class="contact__item">
            ...
            <div class="contact__item-content">
                ...
                <div class="contact__item-content-inner">
                    ...
                    <div class="text <?php echo esc_attr($text_class); ?>"><?php echo esc_html($position); ?></div>
